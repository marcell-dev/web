...
const Home = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Marcell.xd - Projeler</title>
        <meta name="description" content="Marcell.xd'nin geliştirdiği projeleri inceleyin. Web geliştirme, Discord botları ve daha fazlası." />
